...
if (isset($_POST['update'])) {
  ...
  if (!$image_type == 'image/jpg' or !$image_type == 'image/png') {
    ...
    $sql = "update student_detail set fname='$fname',lname='$lname',email='$email',
    ...
    if ($run) {
      echo "<script>window.open('veiw_student.php?update_success=Student data updated successfully','_self')</script>";
    } else {
      echo "<script>window.open('veiw_student.php?update_error=Student data not updated erorr' ,'_self')</script>";
    }
  }
}
?>
